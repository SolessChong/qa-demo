...
Blog
Help
Chong Soless SolessChong
 
336  Watch 
  Star 2,238
 Fork 683fxsjy/jieba
 branch: master jieba / jieba / analyse / textrank.py
walkskyerwalkskyer 10 days ago 为函数textrank增加参数allowPOS，并修改extract_tags的参数allowPOS与textrank保持一致。
3 contributors Dingyuan WangwalkskyerCheng Zhang
92 lines (75 sloc)  3.208 kb RawBlameHistory  
#!/usr/bin/env python
# -*- coding: utf-8 -*-
